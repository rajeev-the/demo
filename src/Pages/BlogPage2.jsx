            ...
            <div className="single-blog-content">
              <div className="single-blog-style-one">
                <div className="img-box">
                  <img src="https://www.nbmcw.com/images/Interviews/40979-Vishal-Agarwal.webp" alt="Awesome Image" />
                </div>
                ...
                Vishal Agarwal, Director - Machino International
                  ...
                  <p>
  <strong>The New Austrian Tunneling Method (NATM) is increasingly being used in road and railway sectors.</strong>
</p>
<br />
<p>
...
<div className="img-box">
                  <img src="https://www.nbmcw.com/images/Interviews/40979-Forepoling-1.webp" alt="Awesome Image" />
                </div>
<br />
...
<br />
 <strong>MIDAS – Pipe Roofing System/ Umbrella System</strong>
<p>
...
<div className="img-box">
                  <img src="https://www.nbmcw.com/images/Interviews/40979-Forepoling-2.webp" alt="Awesome Image" />
                </div>
<br />
 <div>
      <h3>Fields of Application</h3>
      <ul>
        <li>Weak Ground Structure</li>
        <li>Portal Sections</li>
        <li>Frequently Changing Ground Conditions</li>
        <li>Re-Excavation of Collapsed Tunnels</li>
        <li>Urban Tunnelling</li>
      </ul>
    </div>
<br />
 <div>
      ...
      <ul>
        <li>Reducing the ground loss by creating a boundary of stiff material between the soil and tunnel core.</li>
        <li>Stabilizing the ground in the area of newly excavated and unsupported excavation round.</li>
        <li>Distributing loads acting upon the tunnel roof above the freshly excavated round into the in-situ ground ahead of the face and the lined tunnel behind the face.</li>
        <li>Confinement of the tunnel excavation area ahead of the tunnel face.</li>
        <li>Enhancing tunnel face stability by reducing loads acting upon the tunnel face.</li>
        <li>Reducing surface settlement.</li>
      </ul>
    </div>
<br />
 <div>
      <h3>Pipe Roofing Components</h3>
    
      <ul>
        <li>Starter Pipe: First Pipe welded with Ring Bit on one end and female threading on the other end, which can be perforated / non- perforated as per the design requirement.</li>
        <li>Extension Pipe: Female threaded pipe for extension, which can be perforated/non-perforated as per the design requirement.</li>
        <li>Pilot Bit</li>
        <li>Drill Rods</li>
        <li>Grout Plug/Injection Cap</li>
        <li>Threads: Pipes have a trapezoidal thread with double start.</li>
        <li>Sizes of pipe roofing system: 76.1, 88.9, 101.6, 114.3, 139.7, 159,168.3</li>
      </ul>
    </div>
     <div>
      <h3>Typical Design</h3>
    
      <ul>
        <li>20-40 casing tubes per advance.</li>
        <li>Each pile 15 meters long, which gives about 12-meter tunnel advancement.</li>
        <li>Tubes are inclined 3-5 degrees from tunnel advance direction.</li>
        <li>Casing size and other specifications are determined by qualified tunnel engineers and geologists based on the soil/rock conditions.</li>
